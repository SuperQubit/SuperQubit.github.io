define(['dart_sdk', 'packages/example/main'], function(dart_sdk, packages__example__main) {
  'use strict';
  ...
  const main = packages__example__main.main;
  ...
  dart.trackLibraries("packages/example/main_web_entrypoint", {
    "package:example/main_web_entrypoint.dart": main_web_entrypoint
  }, {
